...
<div class="h-100 index-bg">
    <div class="p-3 h-100 shade d-flex flex-column justify-content-center align-items-center">
        ...
        <div class="vh-33 p-3 text-center">
            <img class="h-100 animate__animated animate__infinite animate__pulse animate__slower"
